...
import kr.bi.greenmate.common.util.CustomSpringELParser;
...
public class DistributedLockAop {
    ...
    @Around("@annotation(kr.bi.greenmate.common.aop.annotation.DistributedLock)")
    public Object lock(final ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            try {
                ...
                if (!available) {
                    log.info("Failed to get Lock: {} {}", method.getName(), key);
                } else {
